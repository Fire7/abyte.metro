...
if($this->StartResultCache(false, array(($arParams['USE_FILTER'] == 'Y' ? $arFilterStations : false), ($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups())))){
...
// get metro iblock id;
    ...
    $arrFilter['PROPERTY'][$arParams['FILTER_FIELD']] = $FILTER_ELEMENTS_ID;
}
